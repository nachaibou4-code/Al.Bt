...
const lovePhrases = [
    ...
    "> [LOG_139]:"moi ou Yvick"[cite: 67]",
    "> [LOG_140]:"Alors qu'une tornade se forme au Mexique, elle entraîne l'arrivée par milliers de requins s'abattant sur la ville de Los Angeles. Le propriétaire d'un restaurant en bord de mer (Fin Shepard), aidé par ses amis et sa serveuse (Nova Clarke) part alors à la rescousse de sa famille, incluant ses enfants (Matt et Claudia Shepard) et son ex-femme (April Wexler)."[cite: 67]",
    "> [LOG_141]:"gO REGARDER sHARKnADO BB STP"[cite: 67]",
    "> [LOG_142]:"Fin et April se rendent à New York pour promouvoir le livre « Comment survivre à un Sharknado et autres désastres non-naturels » écrit par April. En avion, ils subissent une violente attaque de requins volants qui tuent les pilotes et de nombreux passagers. Alors qu'April se retrouve un bras en moins, Fin réussit à faire se poser l'avion dans un état critique. S'ensuit une aventure dans New York pour sauver la population."[cite: 67]",
    "> [LOG_143]:"Alors que Fin et April se rendent en vacances en Floride, un ouragan touche toute la côte. Les deux héros doivent une nouvelle fois secourir la population de Sharknado."[cite: 67]",
    "> [LOG_144]:"damn ça fait 6 sharknado"[cite: 67]",
    "> [LOG_145]:"Sharknado (2013), Sharknado 2: The Second One (2014), Sharknado 3: Oh Hell No! (2015), Sharknado: The 4th Awakens (2016), Sharknado 5: Global Swarming (2017), The Last Sharknado: It's About Time (2018)."[cite: 67]",
    "> [LOG_146]:"bb y a Guillaume j'en peux plus"[cite: 67]",
    "> [LOG_147]:"https://maps.app.goo.gl/BiijN6PZo1A8Qx6x6"[cite: 67]",
    ...
    "> [LOG_1409]: "Big up a toutes les chaussettes que je t'ai volé" [cite: 67]",
    "> [LOG_150]:"Bébouuuuuuuuuuuuuuuu est-ce que tu me schneck ???" ça me termine de rire frr,[cite: 67]",
    "> [LOG_152]:"pardon pour l'eau dans les oreilles "[cite: 67]",
    "> [LOG_eRRoOr]:"je suis vrm désolée pour l'eau dans les oreilles frr"[cite: 67]",
    "> [LOG_eRRoOr]:"If I was turned into a lamp, would you still keep me turned on all night or would I just end up in the garage?"[cite: 67]",
    "> [LOG_eRRoOr]:"Azy j'ai repensé au fait que tu as regardé une photo de Tyla pendant plus de 3 secondes hier, je suis officiellement zehef pour la journée."[cite: 67]",
    "> [LOG_eRRoOr]:"Bébouuuuuuuuuuuuuuuu est-ce que tu me bzezs ???"[cite: 67]",
    "> [LOG_eRRoOr]:""[cite: 67]",
    "> [LOG_eRRoOr]:""[cite: 67]",
    "> [LOG_eRRoOr]:""[cite: 67]",
    "> [LOG_eRRoOr]:""[cite: 67]",
